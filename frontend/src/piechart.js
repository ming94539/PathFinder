...
export default function piechart(id, data) {
  let svg = d3.select('svg');
    ...
    document.addEventListener('chartUpdate', function(event) {
      ...
      // let newData = data;
      // console.log('[chartUpdate] newData:', newData);
      // for (let entry in newData) {
      //   console.log('comparing IDs:', entry, id);
      //   if (entry.id == id) {
      //     newData = entry.data;
      //     break;
      //   }
      ...
      //   console.log('comparing:', id, newData[i]);
      //   if (newData[i].id == id) {
      //     newData = newData[i].data;
      //     break;
      //   }
      // }
      // console.log('[chartUpdate] newData after:', newData);
      // let dataEntry = newData.find(e => e.id == id);
      // if (!dataEntry) {
      //   console.log('Could not find data at id:', id);
      //   return;
      // }
      // console.log('data entry:', dataEntry);
      // newData = dataEntry.data;
      // let newData = dataEntry.data;
      // if (!newData) return;
      // let newData = event.detail;
      // let newData = data;
      // console.log('[piechart event] First newData:', newData[0].data);
      // console.log('vs event:', event.detail[0].data);
...
//   console.log('Entered piechart.js');
//   // useEffect(() => {
//   //   drawChart();
//   // }); 
